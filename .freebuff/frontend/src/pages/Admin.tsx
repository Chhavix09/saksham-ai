      ...
      <div className="rounded-2xl border border-emerald-200/80 bg-gradient-to-r from-emerald-50 via-teal-50/50 to-white p-5 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-600">
              Continuously monitors and auto-updates schemes every 24 hours from all 7 official government portals.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {syncMutation.isPending ? 'Syncing Portals...' : 'Sync Schemes Now'}
            </button>
          </div>
        </div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4 border-t border-emerald-100/80 pt-3 text-xs">
          ...
          <div>
            ...
            <div className="text-sm font-bold text-emerald-700">7 National Portals</div>
          </div>
        </div>

        <div className="mt-3 flex flex-wrap gap-1.5 pt-1">
          {['myScheme.gov.in', 'DBT Bharat', 'MSME Portal', 'Rural Development', 'Social Justice & Empowerment', 'National Portal India', 'DOSJE Services'].map((p) => (
